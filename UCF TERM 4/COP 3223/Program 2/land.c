...
//This program will calculate a rectangular enclosure of land when the area
//and desired ratio of length to width are given. It will provide a total fence
//length in feet as well.
