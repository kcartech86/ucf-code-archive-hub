            ...
            <div id="content">
                <div class="container_16 clearfix">
                    ...
                    <div class="grid_14">
                         <div class="table">
                              <div class="table">
                                  <span class="column"><strong>Product</strong></span>
                                  <span class="column"><strong>Product Description</strong></span>
                                  <span class="column"><strong>Unit Price</strong></span>
                                  <span class="column"><strong>Quantity</strong></span>
                                  <span class="column"><strong>Total</strong></span>
                                  <span class="column"><strong>Remove</strong></span>
                              </div>
                              <?php  showCart(); ?>
                         </div>
